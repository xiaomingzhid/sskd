 ...
 */
        __pyx_t_1 = __Pyx_PyInt_AddObjC(__pyx_v_num_g_real, __pyx_int_1, 1, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 65, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
 ...
 */
    ...
    Py_ssize_t __pyx_tmp_shape = __pyx_v_distmat.shape[0];
